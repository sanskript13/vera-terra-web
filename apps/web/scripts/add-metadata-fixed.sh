#!/bin/bash
# Add metadata to all page.tsx files - FIXED
...
import { pageContent, metadata as pageMetadata } from '@/content/pages/PAGE_SLUG'
...
EOF
  # Replace PAGE_SLUG with actual page slug
  sed -i '' "s/PAGE_SLUG/$page/g" "app/$page/page.tsx"
done
